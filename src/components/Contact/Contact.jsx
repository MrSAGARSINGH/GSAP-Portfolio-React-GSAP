      ...
      <div className="contact__container">
        ...
        <div className="contact__card">
          <form
            ...
            action="https://formspree.io/f/mdavvrwg"  // 👈 replace with your Formspree endpoint
            method="POST"
            onKeyDownCapture={(e) => {
              const isField =
      ...
      <div className="contact__footer">
        <div className="contact__footerInner">
          <div className="contact__copyright">
            © {new Date().getFullYear()} SAGAR SINGH KHANGAROT. All rights reserved.
          </div>
          ...
          <div className="contact__links">
            ...
            <a
              href="https://github.com/MrSAGARSINGH"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="GitHub"
            >
